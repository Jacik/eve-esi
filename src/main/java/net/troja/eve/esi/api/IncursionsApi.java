...
public class IncursionsApi {
     ...
     *                        </table>
     */
    public okhttp3.Call getIncursionsCall(@javax.annotation.Nullable String datasource,
    ...
    private okhttp3.Call getIncursionsValidateBeforeCall(@javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String ifNoneMatch, final ApiCallback _callback) throws ApiException {
     ...
     *                        </table>
     */
    public List<IncursionsResponse> getIncursions(@javax.annotation.Nullable String datasource,
     ...
     *                        </table>
     */
    public okhttp3.Call getIncursionsAsync(@javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String ifNoneMatch, final ApiCallback<List<IncursionsResponse>> _callback)
            throws ApiException {
