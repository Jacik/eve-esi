...
public class RoutesApi {
     ...
     *                        </table>
     */
    public okhttp3.Call getRouteOriginDestinationCall(@javax.annotation.Nonnull Integer destination,
            @javax.annotation.Nonnull Integer origin, @javax.annotation.Nullable Set<Integer> avoid,
            @javax.annotation.Nullable Set<Set<Integer>> connections, @javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String flag, @javax.annotation.Nullable String ifNoneMatch,
    ...
    private okhttp3.Call getRouteOriginDestinationValidateBeforeCall(@javax.annotation.Nonnull Integer destination,
            @javax.annotation.Nonnull Integer origin, @javax.annotation.Nullable Set<Integer> avoid,
            @javax.annotation.Nullable Set<Set<Integer>> connections, @javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String flag, @javax.annotation.Nullable String ifNoneMatch,
            final ApiCallback _callback) throws ApiException {
     ...
     *                        </table>
     */
    public List<Integer> getRouteOriginDestination(@javax.annotation.Nonnull Integer destination,
            @javax.annotation.Nonnull Integer origin, @javax.annotation.Nullable Set<Integer> avoid,
            @javax.annotation.Nullable Set<Set<Integer>> connections, @javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String flag, @javax.annotation.Nullable String ifNoneMatch) throws ApiException {
     ...
     *                        </table>
     */
    public ApiResponse<List<Integer>> getRouteOriginDestinationWithHttpInfo(
            @javax.annotation.Nonnull Integer destination, @javax.annotation.Nonnull Integer origin,
            @javax.annotation.Nullable Set<Integer> avoid, @javax.annotation.Nullable Set<Set<Integer>> connections,
            @javax.annotation.Nullable String datasource, @javax.annotation.Nullable String flag,
     ...
     *                        </table>
     */
    public okhttp3.Call getRouteOriginDestinationAsync(@javax.annotation.Nonnull Integer destination,
            @javax.annotation.Nonnull Integer origin, @javax.annotation.Nullable Set<Integer> avoid,
            @javax.annotation.Nullable Set<Set<Integer>> connections, @javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String flag, @javax.annotation.Nullable String ifNoneMatch,
