...
public class SearchApi {
     ...
     *                        </table>
     */
    public okhttp3.Call getCharactersCharacterIdSearchCall(@javax.annotation.Nonnull Set<String> categories,
            @javax.annotation.Nonnull Integer characterId, @javax.annotation.Nonnull String search,
            ...
            @javax.annotation.Nullable Boolean strict, @javax.annotation.Nullable String token,
    ...
    private okhttp3.Call getCharactersCharacterIdSearchValidateBeforeCall(
            @javax.annotation.Nonnull Set<String> categories, @javax.annotation.Nonnull Integer characterId,
            @javax.annotation.Nonnull String search, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String datasource, @javax.annotation.Nullable String ifNoneMatch,
            @javax.annotation.Nullable String language, @javax.annotation.Nullable Boolean strict,
     ...
     *                        </table>
     */
    public CharacterSearchResponse getCharactersCharacterIdSearch(@javax.annotation.Nonnull Set<String> categories,
            @javax.annotation.Nonnull Integer characterId, @javax.annotation.Nonnull String search,
            @javax.annotation.Nullable String acceptLanguage, @javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String language,
            @javax.annotation.Nullable Boolean strict, @javax.annotation.Nullable String token) throws ApiException {
     ...
     *                        </table>
     */
    public ApiResponse<CharacterSearchResponse> getCharactersCharacterIdSearchWithHttpInfo(
            @javax.annotation.Nonnull Set<String> categories, @javax.annotation.Nonnull Integer characterId,
            @javax.annotation.Nonnull String search, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String datasource, @javax.annotation.Nullable String ifNoneMatch,
            @javax.annotation.Nullable String language, @javax.annotation.Nullable Boolean strict,
     ...
     *                        </table>
     */
    public okhttp3.Call getCharactersCharacterIdSearchAsync(@javax.annotation.Nonnull Set<String> categories,
            @javax.annotation.Nonnull Integer characterId, @javax.annotation.Nonnull String search,
            @javax.annotation.Nullable String acceptLanguage, @javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String language,
            @javax.annotation.Nullable Boolean strict, @javax.annotation.Nullable String token,
            final ApiCallback<CharacterSearchResponse> _callback) throws ApiException {
