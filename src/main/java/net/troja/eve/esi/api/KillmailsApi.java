...
public class KillmailsApi {
     ...
     *                        </table>
     */
    public okhttp3.Call getCharactersCharacterIdKillmailsRecentCall(@javax.annotation.Nonnull Integer characterId,
    ...
    private okhttp3.Call getCharactersCharacterIdKillmailsRecentValidateBeforeCall(
     ...
     *                        </table>
     */
    public List<CharacterKillmailsResponse> getCharactersCharacterIdKillmailsRecent(
            @javax.annotation.Nonnull Integer characterId, @javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable Integer page,
     ...
     *                        </table>
     */
    public okhttp3.Call getCharactersCharacterIdKillmailsRecentAsync(@javax.annotation.Nonnull Integer characterId,
            @javax.annotation.Nullable String datasource, @javax.annotation.Nullable String ifNoneMatch,
            @javax.annotation.Nullable Integer page, @javax.annotation.Nullable String token,
     ...
     *                        </table>
     */
    public okhttp3.Call getCorporationsCorporationIdKillmailsRecentCall(
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCorporationsCorporationIdKillmailsRecentValidateBeforeCall(
            @javax.annotation.Nonnull Integer corporationId, @javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable Integer page,
            @javax.annotation.Nullable String token, final ApiCallback _callback) throws ApiException {
     ...
     *                        </table>
     */
    public List<CorporationKillmailsResponse> getCorporationsCorporationIdKillmailsRecent(
            @javax.annotation.Nonnull Integer corporationId, @javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable Integer page,
            @javax.annotation.Nullable String token) throws ApiException {
     ...
     *                        </table>
     */
    public okhttp3.Call getCorporationsCorporationIdKillmailsRecentAsync(
            @javax.annotation.Nonnull Integer corporationId, @javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable Integer page,
            @javax.annotation.Nullable String token, final ApiCallback<List<CorporationKillmailsResponse>> _callback)
            throws ApiException {
    ...
    public okhttp3.Call getKillmailsKillmailIdKillmailHashCall(@javax.annotation.Nonnull String killmailHash,
            @javax.annotation.Nonnull Integer killmailId, @javax.annotation.Nullable String datasource,
    ...
    private okhttp3.Call getKillmailsKillmailIdKillmailHashValidateBeforeCall(
            @javax.annotation.Nonnull String killmailHash, @javax.annotation.Nonnull Integer killmailId,
            @javax.annotation.Nullable String datasource, @javax.annotation.Nullable String ifNoneMatch,
            final ApiCallback _callback) throws ApiException {
    ...
    public okhttp3.Call getKillmailsKillmailIdKillmailHashAsync(@javax.annotation.Nonnull String killmailHash,
            @javax.annotation.Nonnull Integer killmailId, @javax.annotation.Nullable String datasource,
            @javax.annotation.Nullable String ifNoneMatch, final ApiCallback<KillmailResponse> _callback)
            throws ApiException {
